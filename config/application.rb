...
module Actionmap
  class Application < Rails::Application
    ...
    config.session_store :cookie_store, key: '_actionmap_session'
    ...
    # If you are running this app on a different domain, even in development,
    # you will need to add the host here.
